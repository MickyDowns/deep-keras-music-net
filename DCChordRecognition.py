...
def main():
    p = argparse.ArgumentParser(
        ...
        '''The DCChordRecognition program recognises major and minor chords in an audio file by first extracting chroma vectors according to the method described in:
            ...
            and then decoding the most likely chord sequence using a linear-chain Conditional Random Field.
    ...
    # version
    p.add_argument('--version', action='version', version='DCChordRecogniser.2016')
